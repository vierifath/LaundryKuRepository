                ...
                <div class="col-lg-6 col-12 p-0">
                    <div class="card rounded-0 mb-0 px-2">
                        ...
                        <div class="login-footer">
                            ...
                            <p style="font-size:10px">Jika belum mempunyai akun, silakan daftar dahulu !</p>
                        </div>
                        <a href="{{url('/register')}}" class="btn btn-success float-right btn-inline btn-block">Daftar Akun</a>
                        <h3><br></h3>
                    </div>
